##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Sun Jan 22 18:10:35 CET 2023] 
##########################################################################################################################
...
Core/Src/balancer_system.c \
Core/Src/accel_gyro.c \
Core/Src/configurator.c \
Core/Src/balancer_state_machine.c \
Core/Src/logger.c \
Core/Src/servo.c \
Core/Src/ball_reader.c \
Core/Src/pid.c
